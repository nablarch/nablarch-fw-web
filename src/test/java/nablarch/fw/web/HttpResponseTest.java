...
public class HttpResponseTest {
    ...
    public void testParsingMultilineHeaders() {
        ...
        ************************************************/
        ...
        Set-Cookie: cookie11=value11; Max-Age=3600; Path=/; Domain=example.com; Secure; HttpOnly
        ...
        ************************************************/
        ...
        assertEquals(12, res.getCookieList().size());
...
//        assertEquals(true, Cookie.class.getMethod("isHttpOnly").invoke(res.getCookieList().get(10)));
        ...
        assertEquals(3600, res.getCookieList().get(11).getMaxAge());
        assertEquals("/", res.getCookieList().get(11).getPath());
        assertEquals("example.com", res.getCookieList().get(11).getDomain());
        assertTrue(res.getCookieList().get(11).getSecure());
//        assertEquals(true, Cookie.class.getMethod("isHttpOnly").invoke(res.getCookieList().get(11)));
    }
